...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (carouselTrack && carouselPrev && carouselNext) {
    ...
    // Auto-advance carousel (pause on user interaction)
    ...
    carouselPrev.addEventListener('click', pauseAutoAdvance);
    carouselNext.addEventListener('click', pauseAutoAdvance);
    carouselTrack.addEventListener('touchstart', pauseAutoAdvance);
    indicators.forEach(indicator => {
      indicator.addEventListener('click', pauseAutoAdvance);
    });
